...
# Static files (CSS, JavaScript, Images) - настройки статических файлов
...
STATIC_ROOT = BASE_DIR / 'static_files' # Путь к директории, куда будут собраны статические файлы


# Media files - настройки медиа-файлов
MEDIA_URL = 'media/' # URL, по которому будут доступны медиа-файлы
MEDIA_ROOT = BASE_DIR / 'media' # Путь к директории, куда будут сохраняться медиа-файлы
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "Site", "url": "http://localhost:8000", "new_window": True},
